...
class SeventhRound: SKScene,SKPhysicsContactDelegate {


    //determines gap between pipes
    let verticalPipeGap = 220.00
    ...
    override func didMoveToView(view: SKView) {
        ...
        self.view?.makeToast(message: "Round 7")
           self.replayCurrentScene( "Round 7", currentGameSceneIndex: 6)
        ...
        // ground
        let groundTexture = SKTexture(imageNamed: "land7")
        ...
        // skyline
        let skyTexture = SKTexture(imageNamed: "mountainbg")
        ...
        pipeTextureUp = SKTexture(imageNamed: "PipeUp7.png")
        pipeTextureUp.filteringMode = .Nearest
        pipeTextureDown = SKTexture(imageNamed: "PipeDown7.png")
        ...
        // setup our bird
        let birdTexture1 = SKTexture(imageNamed: "Crab7.png")
        birdTexture1.filteringMode = .Nearest

        let birdTexture2 = SKTexture(imageNamed: "Crab7.png")
        ...
        if moving.speed > 0 {
            if ( contact.bodyA.categoryBitMask & scoreCategory ) == scoreCategory || ( contact.bodyB.categoryBitMask & scoreCategory ) == scoreCategory {
                ...
                if (score == 15)
                {
                    ...
                    self.view?.makeToast(message: "Congratulations. You have completed The Seventh round. ")
                    //moving to level two
                    let gameStartScene = ThirdRound(size: self.frame.size)
                ...
                }), SKAction.waitForDuration(NSTimeInterval(0.5))]), count:2), SKAction.runBlock({
