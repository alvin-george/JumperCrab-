...
class FourthRound: SKScene,SKPhysicsContactDelegate {
    ...
    override func didMoveToView(view: SKView) {
        ...
        self.view?.makeToast(message: "Round 4")
        self.replayCurrentScene( "Round 4", currentGameSceneIndex: 3)
        ...
        // ground
        let groundTexture = SKTexture(imageNamed: "land4")
        ...
        // skyline
        let skyTexture = SKTexture(imageNamed: "dog")
        ...
        pipeTextureUp = SKTexture(imageNamed: "PipeUp4.png")
        pipeTextureUp.filteringMode = .Nearest
        pipeTextureDown = SKTexture(imageNamed: "PipeDown4.png")
        ...
        // setup our bird
        let birdTexture1 = SKTexture(imageNamed: "Crab4.png")
        birdTexture1.filteringMode = .Nearest

        let birdTexture2 = SKTexture(imageNamed: "Crab4.png")
        ...
        if moving.speed > 0 {
            if ( contact.bodyA.categoryBitMask & scoreCategory ) == scoreCategory || ( contact.bodyB.categoryBitMask & scoreCategory ) == scoreCategory {
                ...
                if (score == 15)
                {
                    ...
                    self.view?.makeToast(message: "Congratulations. You have completed The Fourth round. ")
                    //moving to level two
                    let gameStartScene = FifthRound(size: self.frame.size)
