...
class NinethRound: SKScene,SKPhysicsContactDelegate {


    //determines gap between pipes
    let verticalPipeGap = 230.00
    ...
    override func didMoveToView(view: SKView) {
        ...
        self.view?.makeToast(message: "Round 9")
        self.replayCurrentScene( "Round 9", currentGameSceneIndex: 0)
        ...
        // ground
        let groundTexture = SKTexture(imageNamed: "land9")
        ...
        // skyline
        let skyTexture = SKTexture(imageNamed: "icybg")
        ...
        pipeTextureUp = SKTexture(imageNamed: "PipeUp9.png")
        pipeTextureUp.filteringMode = .Nearest
        pipeTextureDown = SKTexture(imageNamed: "PipeDown9.png")
        ...
        // setup our bird
        let birdTexture1 = SKTexture(imageNamed: "Crab9.png")
        birdTexture1.filteringMode = .Nearest

        let birdTexture2 = SKTexture(imageNamed: "Crab9.png")
    ...
    override func touchesBegan(touches: Set<UITouch>, withEvent event: UIEvent?) {
        ...
        if moving.speed > 0  {
            for touch: AnyObject in touches {
                ...
                bird.physicsBody?.velocity = CGVector(dx: 0, dy: 0)
                bird.physicsBody?.applyImpulse(CGVector(dx: 0, dy: 58))
        ...
        if moving.speed > 0 {
            if ( contact.bodyA.categoryBitMask & scoreCategory ) == scoreCategory || ( contact.bodyB.categoryBitMask & scoreCategory ) == scoreCategory {
                ...
                if (score == 15)
                {
                    ...
                    self.view?.makeToast(message: "Congratulations. You have completed The Nineth round. ")
                    //moving to level two
