...
class ThirdRound: SKScene, SKPhysicsContactDelegate{

    //determines gap between pipes
    let verticalPipeGap = 205.00
    ...
    override func didMoveToView(view: SKView) {
        ...
        self.view?.makeToast(message: "Round 3")
           self.replayCurrentScene( "Round 3", currentGameSceneIndex: 2)
        ...
        // ground
        let groundTexture = SKTexture(imageNamed: "land3")
        ...
        // skyline
        let skyTexture = SKTexture(imageNamed: "outerspace")
        ...
        pipeTextureUp = SKTexture(imageNamed: "PipeUp3.png")
        pipeTextureUp.filteringMode = .Nearest
        pipeTextureDown = SKTexture(imageNamed: "PipeDown3.png")
        ...
        // setup our bird
        let birdTexture1 = SKTexture(imageNamed: "Crab3.png")
        birdTexture1.filteringMode = .Nearest

        let birdTexture2 = SKTexture(imageNamed: "Crab3.png")
            ...
            if ( contact.bodyA.categoryBitMask & scoreCategory ) == scoreCategory || ( contact.bodyB.categoryBitMask & scoreCategory ) == scoreCategory {
                ...
                if (score == 15)
                {
                    ...
                    self.runAction(SKAction.runBlock{
                        self.backgroundColor = SKColor(red: 0.5, green: 1, blue: 0.5, alpha: 1.0)
                        })

                    self.view?.makeToast(message: "Congratulations. You have completed The Third round. ")
                        //moving to level two
                        let gameStartScene = FourthRound(size: self.frame.size)
