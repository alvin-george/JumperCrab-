...
//  JumperCrab
//
//  Created by fingent on 02/11/15.
...
class SecondRound: SKScene, SKPhysicsContactDelegate{
    ...
    override func didMoveToView(view: SKView) {
        ...
        self.view?.makeToast(message: "Round 2")
           self.replayCurrentScene( "Round 2", currentGameSceneIndex: 1)
        ...
        // ground
        let groundTexture = SKTexture(imageNamed: "land2")
        ...
        // skyline
        let skyTexture = SKTexture(imageNamed: "rockbg")
        ...
        pipeTextureUp = SKTexture(imageNamed: "PipeUp2.png")
        pipeTextureUp.filteringMode = .Nearest
        pipeTextureDown = SKTexture(imageNamed: "PipeDown2.png")
        ...
        // setup our bird
        let birdTexture1 = SKTexture(imageNamed: "Crab2.png")
        birdTexture1.filteringMode = .Nearest

        let birdTexture2 = SKTexture(imageNamed: "Crab2.png")
        ...
        if moving.speed > 0 {
            if ( contact.bodyA.categoryBitMask & scoreCategory ) == scoreCategory || ( contact.bodyB.categoryBitMask & scoreCategory ) == scoreCategory {
                ...
                if (score == 15)
                {
                    ...
                    self.view?.makeToast(message: "Congratulations. You have completed The Second round. ")
                        //moving to level two
