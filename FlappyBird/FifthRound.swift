...
class FifthRound: SKScene,SKPhysicsContactDelegate {
    ...
    override func didMoveToView(view: SKView) {
        ...
        self.view?.makeToast(message: "Round 5")
           self.replayCurrentScene( "Round 5", currentGameSceneIndex: 4)
        ...
        // ground
        let groundTexture = SKTexture(imageNamed: "land5")
        ...
        // skyline
        let skyTexture = SKTexture(imageNamed: "sea")
        ...
        pipeTextureUp = SKTexture(imageNamed: "PipeUp5.png")
        pipeTextureUp.filteringMode = .Nearest
        pipeTextureDown = SKTexture(imageNamed: "PipeDown5.png")
        ...
        // setup our bird
        let birdTexture1 = SKTexture(imageNamed: "Crab5.png")
        birdTexture1.filteringMode = .Nearest

        let birdTexture2 = SKTexture(imageNamed: "Crab5.png")
        ...
        if moving.speed > 0 {
            if ( contact.bodyA.categoryBitMask & scoreCategory ) == scoreCategory || ( contact.bodyB.categoryBitMask & scoreCategory ) == scoreCategory {
                ...
                if (score == 15)
                {
                    ...
                    self.view?.makeToast(message: "Congratulations. You have completed The Fifth round. ")
                    //moving to level two
                    let gameStartScene = SixthRound(size: self.frame.size)
