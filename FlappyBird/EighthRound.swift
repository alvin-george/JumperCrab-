...
class EighthRound: SKScene,SKPhysicsContactDelegate {
    ...
    override func didMoveToView(view: SKView) {
        ...
        self.view?.makeToast(message: "Round 8")
           self.replayCurrentScene( "Round 8", currentGameSceneIndex: 7)
        ...
        // ground
        let groundTexture = SKTexture(imageNamed: "land8")
        ...
        // skyline
        let skyTexture = SKTexture(imageNamed: "naturbg")
        ...
        pipeTextureUp = SKTexture(imageNamed: "PipeUp8.png")
        pipeTextureUp.filteringMode = .Nearest
        pipeTextureDown = SKTexture(imageNamed: "PipeDown8.png")
        ...
        // setup our bird
        let birdTexture1 = SKTexture(imageNamed: "Crab8.png")
        birdTexture1.filteringMode = .Nearest

        let birdTexture2 = SKTexture(imageNamed: "Crab8.png")
        ...
        if moving.speed > 0 {
            if ( contact.bodyA.categoryBitMask & scoreCategory ) == scoreCategory || ( contact.bodyB.categoryBitMask & scoreCategory ) == scoreCategory {
                ...
                if (score == 15)
                {
                    ...
                    self.view?.makeToast(message: "Congratulations. You have completed The Eighth round. ")
                    //moving to level two
